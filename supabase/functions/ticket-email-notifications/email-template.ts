...
const EVENT_COPY: Record<TicketEmailEventType, { label: string; headline: string; tone: string; summary: string }> = {
  ...
  sla_expiry: {
    label: 'SLA expiring soon',
    headline: 'SLA deadline is less than 3 hours away',
    tone: '#b45309',
    summary: 'This ticket\'s SLA window is closing. Please update the status or escalate immediately.',
  },
};
